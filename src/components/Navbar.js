    ...
    return(
      <div>
        <nav className="navbar navbar-light">
          <span className="navbar-brand mb-0 h1"><h1><NavLink className="gigHunterLogo" to='/'>Gig Hunter</NavLink></h1></span>
          <span>
            <NavLink className='ui blue button' to='/'>Home <i className="home icon"></i></NavLink>
            {/* <button className='ui blue button'>Friend Requests <i class="users icon"></i></button> */}
            <FriendRequestDropdown><i class="users icon"></i></FriendRequestDropdown>
